...
{
<?= $generator->generateRouteForControllerMethod('/', sprintf('%s_index', $route_short_name), ['GET']) ?>
<?php if (isset($repository_full_class_name)): ?>
...
<?= $generator->generateRouteForControllerMethod('/new', sprintf('%s_new', $route_short_name), ['GET', 'POST']) ?>
...
<?= $generator->generateRouteForControllerMethod(sprintf('/{%s}', $entity_identifier), sprintf('%s_show', $route_short_name), ['GET']) ?>
...
<?= $generator->generateRouteForControllerMethod(sprintf('/{%s}/edit', $entity_identifier), sprintf('%s_edit', $route_short_name), ['GET', 'POST']) ?>
...
<?= $generator->generateRouteForControllerMethod(sprintf('/{%s}', $entity_identifier), sprintf('%s_delete', $route_short_name), ['POST']) ?>
