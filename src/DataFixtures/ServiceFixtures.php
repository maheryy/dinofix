...
class ServiceFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function getServiceDetails() {
        ...
        [
            ...
            "description" => "Contrôle technique de votre dino. Notre service vérifie la qualité de votre dino ainsi que la présence de tous ses os afin de conforter à la réglementation française des animaux préhistoriques.",
        ],
        [
